...
import com.sad25kag.SuperStreamExtractor.invokeSubtitleAPI
import com.sad25kag.SuperStreamExtractor.invokeSuperstream
import com.sad25kag.SuperStreamExtractor.invokeSuperstreamFeb
...
open class SuperStream(sharedPref: SharedPreferences? = null) : TmdbProvider() {
    ...
    companion object {
        ...
        private const val REMOTE_PROXY_LIST = "https://raw.githubusercontent.com/sad25kag/TVVVV/refs/heads/main/Proxylist.txt"
