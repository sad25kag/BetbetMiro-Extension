    ...
    override suspend fun search(query: String): List<SearchResponse> {
            ...
            return app
                ...
                ?.map {
                    newAnimeSearchResponse(
                        ...
                        posterUrl = "https://raw.githubusercontent.com/sad25kag/TVVVV/refs/heads/main/Icons/aniworld.jpg"
                    }
                }
                ?: emptyList()
        }
        ...
        return tryParseJson<List<AnimeSearch>>(json.text)?.filter {
            ...
            newAnimeSearchResponse(
                ...
                this.posterUrl = "https://raw.githubusercontent.com/sad25kag/TVVVV/refs/heads/main/Icons/aniworld.jpg"
            }
